...
class RegistrationViewModel @Inject constructor(
    ...
    fun onBirthDateChange(newDateMillis: Long?) {
        if (newDateMillis != null){
            val formattedDate = Instant.ofEpochMilli(newDateMillis)
            ...
            _uiState.update {
                it.copy(
                    birthdayDisplay = formattedDate,
                    birthday = newDateMillis,
                    birthDateError = "Birth date must be selected"
                )
            }
        }
        ...
        viewModelScope.launch {
            try {
                ...
                val newUser = User(
                    ...
                    birthDate = state.birthday!!, // !! is safe because validateAllFields() checks for null
    ...
    private fun validateAllFields(): Boolean {
        ...
        onBirthDateChange(state.birthday)
